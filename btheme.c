...
enum
{
	...
	R_ALBG, R_ALFG, R_PANEL, R_TITBG, R_TITFG, R_N
};
...
static const PRESET presets[] =
{
	...
	/* 1: Slate - dark developer scheme, indigo selection */
	{ "Slate", 1,
	  { {0x33,0x41,0x55}, {0xF1,0xF5,0xF9}, {0x47,0x55,0x69}, {0x0F,0x17,0x2A},
	    {0x81,0x8C,0xF8}, {0xFF,0xFF,0xFF}, {0xDC,0x26,0x26}, {0xFF,0xFF,0xFF},
	    {0x1E,0x29,0x3B}, {0x0F,0x17,0x2A}, {0xF1,0xF5,0xF9} },
	  6, 3, 8, 0 },
	...
	{ "Midnight", 1,
	  { {0x27,0x27,0x2A}, {0xFA,0xFA,0xFA}, {0x3F,0x3F,0x46}, {0x09,0x09,0x0B},
	    ...
	    {0x18,0x18,0x1B}, {0x09,0x09,0x0B}, {0xFA,0xFA,0xFA} },
	  6, 3, 8, 0 },
	...
	{ "Navy Gold", 1,
	  { {0x12,0x36,0x5A}, {0xF8,0xFA,0xFC}, {0x1E,0x4E,0x80}, {0x07,0x1A,0x2E},
	    ...
	    {0x0A,0x25,0x40}, {0x0A,0x25,0x40}, {0xC7,0xA8,0x4B} },
	  6, 3, 8, 0 },
	...
	{ "Paper", 1,
	  { {0xFA,0xFA,0xF8}, {0x1C,0x19,0x17}, {0xFF,0xFF,0xFF}, {0xD6,0xD3,0xD1},
	    ...
	    {0xF5,0xF0,0xEB}, {0xE7,0xE0,0xD8}, {0x1C,0x19,0x17} },
	  6, 3, 8, 0 },
	...
	{ "SaaS Light", 1,
	  { {0xFF,0xFF,0xFF}, {0x0F,0x17,0x2A}, {0xFF,0xFF,0xFF}, {0xCB,0xD5,0xE1},
	    ...
	    {0xF1,0xF5,0xF9}, {0xE2,0xE8,0xF0}, {0x0F,0x17,0x2A} },
	  6, 3, 8, 0 },
};
